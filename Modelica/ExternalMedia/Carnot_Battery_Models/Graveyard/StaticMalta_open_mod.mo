...
model StaticMalta_open_mod
  ...
  */
  ...
  /*  
    ...
    SI.Temperature T_4_a_charge_guess=from_degC(18.14)  "state  temperature";
    SI.Pressure p_4_a_charge_guess=98942"state  pressure";
    WorkingFluid.ThermodynamicState state_4_a_charge_guess(p(start=98942),T(start=from_degC(18.14))) "thermodynamic state";
    WorkingFluid.SpecificEnthalpy h_4_a_charge_guess(start=417519) "enthalpy";
    WorkingFluid.SpecificEntropy s_4_a_charge_guess(start=3862) "spec. entropy";    
      */
  //state 2 charge
  ...
  /*
    //SI.Temperature T_3_a_charge_alg(start=from_degC(281.29)) "outlet temperature after HEX";
    Real delta_T_3_a_alg(start=from_degC(15));
    parameter Real delta_T_3_a_target=1;
    Integer i;
    */
