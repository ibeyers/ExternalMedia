...
/*
    ...
    parameter Real SOC_tank1_start = 0.866549;
    parameter SI.Temperature T_tank1_start = from_degC(566.04);
    parameter Real SOC_tank2_start = 0.246842;
    parameter SI.Temperature T_tank2_start = from_degC(271.45);
    parameter Real SOC_tank3_start = 0.212406;
    parameter SI.Temperature T_tank3_start = from_degC(25.143);
    parameter Real SOC_tank4_start = 0.7704;
    parameter SI.Temperature T_tank4_start = from_degC(-58.1667);
*/
  //--------------------------PARAMETERS & VARIABLES SYSTEM-----------------------------//
  parameter SI.Temperature T0 = 273.15;
  parameter SI.Temperature T_0_MMA = 276.69;
  parameter SI.Temperature T_amb = from_degC(22);
  //-------------Charge//
  //design
  ...
  parameter SI.Diameter D_tank_solsalt = 36.0377;
  parameter SI.Height h_tank_solsalt = 12.0126;
  ...
  parameter SI.Height x_tank1_solsalt_max = x_tank_solsalt_min+ 10.92;
  parameter SI.Height x_tank2_solsalt_max = x_tank_solsalt_min+ 9.885;
  ...
  parameter SI.Density rho_tank1_nom = 1730.28;
 ...
 parameter Real n_CO_charge = 3000 "actual speed";
  ...
  parameter SI.Temperature T_2_a_charge = from_degC(22) "outlet temperature after rejec";
...
//--------------------------COMPONENT MANAGEMENT--------------------------//
  ...
  annotation(
    Documentation(info = "<html><head></head><body>Dynamic Malta Charge &amp; discharge<div>Heat loss set to zero</div><div><br></div></body></html>"));
