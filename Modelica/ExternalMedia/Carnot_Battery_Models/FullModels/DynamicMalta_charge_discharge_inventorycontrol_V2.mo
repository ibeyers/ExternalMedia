...
model DynamicMalta_charge_discharge_inventorycontrol_V2
  //--------------------------IMPORTS-----------------------------//
...
*/
  ...
  parameter SI.Power P_set(displayUnit = "MW") = -109*1000*1000;
...
end DynamicMalta_charge_discharge_inventorycontrol_V2;
