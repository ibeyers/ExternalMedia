...
model Transformer_180MVA
  ...
  parameter SI.Power P_set(displayUnit = "MW") = -162*1000*1000;
  parameter Modelica.Units.SI.ReactivePower Q_set(displayUnit = "Mvar") = -78.46*1000*1000;
  ...
  parameter SI.ApparentPower S_TR_nom(displayUnit = "MVA") = 180*1000*1000;
  ...
  parameter SI.Voltage U_TR_LV_nom(displayUnit = "kV") = 10.5*1000  "RMS voltage of the low voltage side, line-to-line";
  parameter Real a = U_TR_HV_nom/U_TR_LV_nom "turns ratio";
  parameter Real u_TR_ohmic_OC = 0.30768704706522554;
  parameter Real i_TR_OC = 0.33790447265541856;
  parameter Real P_TR_loss_OC_div_S_TR_nom = 0.06383695063265923;
  parameter SI.Power P_TR_loss_OC(displayUnit = "kW") = (P_TR_loss_OC_div_S_TR_nom/100)*S_TR_nom;
  parameter Real u_TR_SC = 11.662459195702269;
  parameter SI.Current I_TR_max = 494.87165930539356 "maximum transformer current";
