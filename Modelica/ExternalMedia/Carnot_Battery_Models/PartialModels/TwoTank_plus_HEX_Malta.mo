 ...
 */
  ...
  */
  ...
  //--------------------------TANK 2
  //parameter SI.SpecificHeatCapacity cp_tank2 = 1495.46;
  //parameter SI.Density rho_tank2=1896.02;
  //parameter SI.SpecificEnthalpy h_tank2=419219.427;
  ...
  parameter SI.SpecificEnthalpy h_out_tank2 = 1; //dummy value TO_DO
  ...
  */
    //-------------ALL HEX//
  parameter Real f_p=0.016; //pressure loss factor
  //-------------HEX 1//
  //design
  ...
  /*
  //-------------HEX RECUP//
  parameter Real UA_HEX_recup = 15179115;
  ...
  */
  ...
  /*
  // INITIAL
  parameter SI.Temperature T_1_initial = from_degC(-55.455) "ambient temperature";
  parameter SI.Pressure p_1_initial = 101325 "ambient pressure";
  parameter SI.SpecificEnthalpy h_1_initial = 304060;
  parameter SI.SpecificEntropy s_1_initial = 6817;
  ...
  */
  SI.Pressure p_2 = 591100 "pressure coming out of compressor";
  /*
  WorkingFluid.ThermodynamicState state_2 "thermodynamic state of compressor outlet";
  WorkingFluid.SpecificEnthalpy h_2(start = 535858) "compressor outlet enthalpy";
  ...
  */
  ...
  SI.Temperature T_3_a = from_degC(260) "outlet temperature after recuperation";
    WorkingFluid.SpecificEnthalpy h_3_a(start = 543754) "compressor outlet enthalpy";
  WorkingFluid.SpecificEntropy s_3_a "compressor outlet spec. entropy";
    SI.Pressure p_3_a(start = 607950) "Pressure after recup";
  //STATE 3
  ...
  SI.Pressure p_3(start = 607950) "Pressure after HEX";
  WorkingFluid.SpecificEnthalpy h_3(start = 880358) "HEX outlet enthalpy";
  WorkingFluid.SpecificEntropy s_3 "HEX outlet spec. entropy";
  /*
  //STATE 4 isentropic
  SI.Temperature T_4_is "isentropic outlet temperature of turbine";
  ...
  //STATE 4
  SI.Pressure p_4 " pressure at turb outlet";
  ...
  //STATE 4 a
  SI.Pressure p_4_a  " pressure at recuperation outlet";
  ...
  */
  ...
  /*
  parameter SI.Temperature T_1_nom = from_degC(-55.45) "design compressor inlet temperature";
  parameter SI.Pressure p_1_nom = 101325 "design compressor inlet pressure";
  parameter SI.Temperature T_3_nom =  from_degC(555) "design compressor inlet temperature";
  parameter SI.Pressure p_3_nom = beta_CO_nom*p_1_nom "design turbine inlet pressure";
*/
...
//discharge: inlet cold side= state_3_a inlet hot side=solsalt_tank1_state
  ...
  C_hot_HEX1 = C_cold_HEX1; //balanced operation
  ...
  solsalt_HEX1_tank2.T=T_in_tank2;//To-Do unneccessary state
  solsalt_HEX1_tank2.p=p_amb;//To-Do unneccessary state 
  h_in_tank2=solsalt_HEX1_tank2.h;//To-Do unneccessary state
   //off-design
