...
model Transformer_250MVA
  ...
  parameter SI.Power P_set(displayUnit = "MW") = -225*1000*1000;
  parameter Modelica.Units.SI.ReactivePower Q_set(displayUnit = "Mvar") = -108.97247*1000*1000;
  ...
  SI.ReactivePower Q_TR_set(displayUnit = "MW",start = 0*1000*1000);

  //------------------TRANSFORMER
  //transformer parameters
  parameter SI.ApparentPower S_TR_nom(displayUnit = "MVA") = 150*1000*1000;
  parameter SI.Voltage U_TR_HV_nom(displayUnit = "kV") = 230*1000 "RMS voltage of the high voltage side (fixed by upper grid), line-to-line";
  parameter SI.Voltage U_TR_LV_nom(displayUnit = "kV") = 118*1000  "RMS voltage of the low voltage side, line-to-line";
  parameter Real a = U_TR_HV_nom/U_TR_LV_nom "turns ratio";
  parameter Real u_TR_ohmic_OC = 0.2756726147720465;
  parameter Real i_TR_OC = 0.30425985304689873;
  parameter Real P_TR_loss_OC_div_S_TR_nom = 0.05800097497862569;
  parameter SI.Power P_TR_loss_OC(displayUnit = "kW") = (P_TR_loss_OC_div_S_TR_nom/100)*S_TR_nom;
  parameter Real u_TR_SC = 12.149640736922905;
  parameter SI.Current I_TR_max = 687.3217490352688"maximum transformer current";
