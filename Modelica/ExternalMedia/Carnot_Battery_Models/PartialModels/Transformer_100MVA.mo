...
model Transformer_100MVA
  ...
  parameter Modelica.Units.SI.ReactivePower Q_set(displayUnit = "Mvar") = -43.5889*1000*1000;
  ...
  SI.ReactivePower Q_TR_set(displayUnit = "MW",start = -43.6*1000*1000);

  //------------------TRANSFORMER
  //transformer parameters
  parameter SI.ApparentPower S_TR_nom(displayUnit = "MVA") = 100*1000*1000;
  ...
  parameter Real u_TR_ohmic_OC = 0.3694767569455967;
  parameter Real i_TR_OC = 0.40619099569305767;
  parameter Real P_TR_loss_OC_div_S_TR_nom = 0.07507160000000002;
  parameter SI.Power P_TR_loss_OC(displayUnit = "kW") = (P_TR_loss_OC_div_S_TR_nom/100)*S_TR_nom;
  parameter Real u_TR_SC = 10.826046577614033;
  parameter SI.Current I_TR_max =916.4289987136918 "maximum transformer current";
